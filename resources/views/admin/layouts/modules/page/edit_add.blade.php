                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="input-group">
                                <input type="text" name="name" id="name" class="form-control"
                                    value="{{$page->name ?? old('name')}}" placeholder="Page Title">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-lg-12 d-flex justify-content-center">
                                    @if (isset($page->image))
                                    <br>
                                    <img src="{{asset($page->thumbnail('image','small'))}}" alt="{{$page->name ?? ''}}"
                                        class="img-fluid" id="page_image">
                                    @endif
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="input-group">
                                <input type="text" name="meta_name" id="meta_name" class="form-control"
                                    value="{{$page->meta_name ?? old('meta_name')}}" placeholder="SEO Title">
                            </div>
                        </div>
                    </div>
                    <br>
