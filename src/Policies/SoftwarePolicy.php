...
class SoftwarePolicy
{
    ...
    {
        return $user->userCanDo('Software', 'browse');
    }
    ...
    {
        return $user->userCanDo('Software', 'read');
    }
    ...
    {
        return $user->userCanDo('Software', 'add');
    }
    ...
    {
        return $user->userCanDo('Software', 'edit');
    }
    ...
    {
        return $user->userCanDo('Software', 'delete');
    }
