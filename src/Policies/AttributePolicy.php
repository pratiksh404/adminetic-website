...
class AttributePolicy
{
    ...
    {
        return $user->userCanDo('Attribute', 'browse');
    }
    ...
    {
        return $user->userCanDo('Attribute', 'read');
    }
    ...
    {
        return $user->userCanDo('Attribute', 'add');
    }
    ...
    {
        return $user->userCanDo('Attribute', 'edit');
    }
    ...
    {
        return $user->userCanDo('Attribute', 'delete');
    }
